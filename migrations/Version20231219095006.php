 ...
 */
final class Version20231219095006 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE invoice (id INT NOT NULL, driving_school_id INT NOT NULL, name VARCHAR(255) NOT NULL, description TEXT NOT NULL, date DATE NOT NULL, type_payment VARCHAR(255) NOT NULL, price INT NOT NULL, PRIMARY KEY(id))');
